/**
 * The base of the LibertyBans API. <br>
 * <br>
 * <b>Nullability</b> <br>
 ...
 * Generally, objects are immutable and thread safe. The only exception to this rule are <i>builder</i> objects, which
 * are mutable and <i>unsafe</i> for concurrent use. It is only intended for builders to be used from a single thread.
 * 
 */

 ...
 * cannot have more than 1 ban, therefore a ban may be undone if the victim is known. <br>
 * <br>
 * Only active punishments can be undone. Historical punishments cannot be removed. See
 * {@link space.arim.libertybans.api.punish} for a description of active and historical punishments. <br>
 * <br>
...
public interface PunishmentRevoker {
	...
	/**
	 * Gets a {@link RevocationOrder} to undo a punishment by its type and victim. <b>This may only be used for singular punishments

...
public class PunishmentChangeReasonEvent extends AbstractPunishmentEvent implements Cancellable {
	
	private boolean cancelled;
	
	public PunishmentChangeReasonEvent(Punishment punishment) {
		super(punishment);
	}

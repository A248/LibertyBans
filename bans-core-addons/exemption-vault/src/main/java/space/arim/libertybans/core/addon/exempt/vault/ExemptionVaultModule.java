...
public final class ExemptionVaultModule extends AddonBindModule {

	@MultiBinding
	public Addon<?> exemptionVaultAddon(ExemptionVaultAddon exemptionVaultAddon) {
		return exemptionVaultAddon;
	}

	@MultiBinding
	public ExemptProvider exemptProvider(VaultExemptProvider exemptProvider) {

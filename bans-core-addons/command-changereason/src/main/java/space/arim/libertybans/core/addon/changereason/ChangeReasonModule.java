...
public final class ChangeReasonModule extends AddonBindModule {

	@MultiBinding
	public Addon<?> changeReasonAddon(ChangeReasonAddon addon) {
		return addon;
	}

	@MultiBinding
	public SubCommandGroup changeReasonCommand(ChangeReasonCommand changeReasonCommand) {
		return changeReasonCommand;
	}

...
public class UsageSectionTest {
	...
	@Test
	public void punish() {
		assertEquals(TextComponent.ofChildren(
				deserialize("&bPunish commands:"),
				Component.newline(),
				deserialize("&e/ban, /ipban &7- ban players"),
				Component.newline(),
				deserialize("&e/mute, /ipmute &7- mute players"),
				Component.newline(),

...
-- This whole migration will be executed in a DDL transaction (PostgreSQL).
-- Note that CockroachDB may not have this capability and experience a brief interruption.


-- Drop views upon which this column depends

DROP VIEW "${tableprefix}applicable_history";

DROP VIEW "${tableprefix}applicable_active";

DROP VIEW "${tableprefix}simple_active";

DROP VIEW "${tableprefix}simple_history";

DROP VIEW "${tableprefix}applicable_bans";

DROP VIEW "${tableprefix}applicable_mutes";

DROP VIEW "${tableprefix}applicable_warns";

DROP VIEW "${tableprefix}simple_bans";

DROP VIEW "${tableprefix}simple_mutes";

DROP VIEW "${tableprefix}simple_warns";

-- Update column length

ALTER TABLE "${tableprefix}scopes" ALTER "value" TYPE VARCHAR(255);

...
BEGIN
	...
	INSERT INTO `libertybans_punishments` (`type`, `operator`, `reason`, `scope`, `start`, `end`) VALUES ('MUTE', operator_var, reason_var, scope_var, start_var, end_var);

	INSERT IGNORE INTO `libertybans_mutes` (`id`, `victim`, `victim_type`) VALUES (LAST_INSERT_ID(), victim_var, victim_type_var);

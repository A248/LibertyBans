...
import space.arim.libertybans.core.schema.tables.ApplicableActive;
import space.arim.libertybans.core.scope.ScopeType;

import java.time.Instant;
import java.util.UUID;

public record ApplicableActiveFields(ApplicableActive table) implements ApplicableViewFields {
	@Override

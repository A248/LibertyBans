...
import space.arim.libertybans.core.schema.tables.ApplicableHistory;
import space.arim.libertybans.core.scope.ScopeType;

import java.time.Instant;
import java.util.UUID;

public record ApplicableHistoryFields(ApplicableHistory table) implements ApplicableViewFields {
	@Override
